        ...
        >
          ...
          <div className='app__works-buttons app__flex'>
            <div 
              ...
              className='app__flex' onClick={() => handleClick(currentIndex === 0 ? Math.floor(works.length / 4) * 4 : currentIndex - 4)}> 
              <HiChevronLeft/>
            </div>
            <div 
              style={{ opacity: (filterWork.length < 4) || (currentIndex + 4 === filterWork.length) || (currentIndex >= Math.floor(filterWork.length / 4) *4) ? 0.5 : 1, pointerEvents: (filterWork.length < 4) || (currentIndex + 4 === filterWork.length) || (currentIndex >= Math.floor(filterWork.length / 4) * 4) ? 'none' : 'auto' }}  
              className='app__flex' onClick={() => handleClick(currentIndex + 4)}> 
              <HiChevronRight/>
            </div>
          </div>
      </div>
